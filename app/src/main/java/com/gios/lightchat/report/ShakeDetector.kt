...
import com.gios.lightchat.util.ShakeGesture
 ...
 * phone that is showing something else should file a report against LightChat.
 *
 * The decision of what counts as a shake is in `util/ShakeGesture` and is plain arithmetic; this
