...
/** What the accelerometer is saying right now, for the readout on the settings screen. */
 ...
 * publishing every one of those samples into a flow nobody collects is pure waste.
 */
object ShakeMonitor {
