...
| v2.1.x | Opening a chat no longer opens the keyboard; shake three times to file a bug report; Save an unknown sender to contacts; the dialer lists nobody until you type, and pinning moved to the row's long-press |
